...
if 'chat_threads' not in st.session_state:
    st.session_state['chat_threads'] = {}  # * UPDATED: dict {thread_id: title} instead of list
...
for thread_id, title in list(st.session_state['chat_threads'].items())[::-1]:  # Display threads in reverse order (most recent first)
